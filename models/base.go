...
var exhibitMapToNum = map[string]int{
	...
	"cat1Rec": 1, "cat2Rec": 2, "cotSimRec": 3, "simAthRec": 4, "catRec": 5, "livStmRec": 6, "popRec": 7, "icfKnnRec": 8, "ucfKnnRec": 9, "nerIcfKnnRec": 10, "codMdlRec": 11, "subMdlRec": 12, "redMdlSub": 13, "othRec": 14,
...
var exhibitMapToString = map[string]string{
	...
	"allRec": "全策略叠加", "cat1Rec": "一级同分类", "cat2Rec": "二级同分类", "cotSimRec": "内容相似", "simAthRec": "同作者", "catRec": "同分类", "livStmRec": "实时流", "popRec": "流行度", "icfKnnRec": "物品协同", "ucfKnnRec": "用户协同", "nerIcfKnnRec": "近期协同", "codMdlRec": "冷启动", "subMdlRec": "订阅模型", "redMdlSub": "阅读模型", "othRec": "其它策略",
